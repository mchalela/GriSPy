...
def test_custom_distance_lev():
    ...
    # numpy 2.0's quicksort change reordered bubble_neighbors output
    # (order is not part of the API), breaking the old list compare;
    # compare as a set instead.
    assert set(lev_ind[0]) == {
        648,
        516,
        705,
        910,
