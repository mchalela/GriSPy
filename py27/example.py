...
# La periodicidad se puede mandar cuando se crea la grid como en la linea anterior,
# o se puede setear despues de crear la grid:
# gsp = GriSPy(data)
...
shell_dist, shell_ind = gsp.shell_neighbors(centres, distance_lower_bound=lower_radii, distance_upper_bound=upper_radii)
